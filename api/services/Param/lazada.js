...
module.exports = async (id_category,token)=>{
	let options = {
		url:get_url('https://api.lazada.vn/rest/category/attributes/get?primary_category_id='+id_category+'&app_key=119201&sign_method=sha256&timestamp='+Date.now()+'&access_token='+token),
		method:'GET',
		headers:{
